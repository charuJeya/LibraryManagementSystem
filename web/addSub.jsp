...
<div class="container">
  <form action="addSubController" method="post">
	...
	<div class="row">
     ...
     <div class="row">
      <div class="col-25">
        <label for="Main Classification Id">Main Classification Name</label>
      </div>
      <div class="col-75">
        <input type="text" id="mainClassificationName" name="mainClassificationName" placeholder="Main Classification Name...">
      </div>
    </div>
